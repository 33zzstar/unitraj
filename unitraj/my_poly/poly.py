...
sys.path.append('/zzs/everything-polynomial/cmotap/continental-multi-object-tracker-and-predictor/')
...
# 加载先验数据
with open('/zzs/everything-polynomial/Argo2/priors_argo2/vehicle/vehicle_5s_new.json', "r") as read_file:
    prior_vehicle = json.load(read_file)

with open('/zzs/everything-polynomial/Argo2/priors_argo2/cyclist/cyclist_5s_new.json', "r") as read_file:
    prior_cyclist = json.load(read_file)

with open('/zzs/everything-polynomial/Argo2/priors_argo2/pedestrian/pedestrian_5s_new.json', "r") as read_file:
